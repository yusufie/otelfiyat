...
const HotelPhotoGallery: FC<{ photos: string[] }> = ({ photos }) => {
  ...
  return (
    <div className=' w-full mx-auto pt-24'>
      <div className='grid md:grid-cols-2 relative gap-6 p-4'>
        <div className='h-[540px] relative rounded-2xl overflow-hidden'>
          <div className='hidden md:flex justify-center items-center w-full h-full'>
            <Image
              src={photos[0]}
              alt={`Room Photo ${currenPhotoIndex + 1}`}
              className='object-cover w-full h-full hover:scale-125 transition-all duration-700 cursor-pointer'
              width={150}
              height={150}
